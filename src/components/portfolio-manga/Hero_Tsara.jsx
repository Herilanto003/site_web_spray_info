...
const Hero = () => {
  ...
  const texts = [
    ...
    "Passionnée de Communication Visuelle",
  ];
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
            Je conçois des visuels percutants, gère des communautés en ligne et
            rédige du contenu engageant. Spécialisée en design graphique,
            réseaux sociaux et stratégie de marque.
          </p>
